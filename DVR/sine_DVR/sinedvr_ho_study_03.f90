...
! Compilation comands
!----------------------------------------------------------
! 1) create out-data-folder: mkdir ../data_ho_study_03
! 2) compile subrutine: gfortran -c mmlib.f
! 3) compile program: gfortran sinedvr_ho_study_03.f90 mmlib.o -L/home/mendez/lapack-3.10.0 -llapack -lrefblas -o sinedvr_ho_study_03
! 4) run: ./sinedvr_ho_study_03
...
program sindvr1d
	...
	open( 20, file = '../data_ho_study_03/parameters.dat' )
	open( 30, file = '../data_ho_study_03/energies_e_vs_L.dat' )
	open( 40, file = '../data_ho_study_03/energies_o_vs_L.dat' )
	...
	write( 20, * )	'number values of L = ', L_max_integer, 'L minimum = ', L_min, &
					'L maximum = ', L_max, 'N = ', gdim, 'omega = ', omega
	close( 20 )
