...
! Compilation comands
!----------------------------------------------------------
! 1) create out-data-folder: mkdir ../data_ho_study_02_v1
! 2) compile subrutine: gfortran -c mmlib.f
! 3) compile program: gfortran sinedvr_ho_study_02_v1.f90 mmlib.o -L/home/mendez/lapack-3.10.0 -llapack -lrefblas -o sinedvr_ho_study_02_v1
! 4) run: ./sinedvr_ho_study_02_v1
! 5) performance: perf stat ./sinedvr_ho_study_02_v1
...
program sindvr1d
	...
	real( 8 )					start_T1, end_T1, start_T2, end_T2, &
								start_T3, end_T3, start_T4, end_T4, &
	...
	open( 30, file = '../data_ho_study_02_v1/eigenvals_e_vs_N.dat' )
	open( 40, file = '../data_ho_study_02_v1/eigenvals_o_vs_N.dat' )
	...
	do gdim_index = gdim_min, gdim_max, 10
		...
		call cpu_time( start_T4 )
		!------------------------------------------------------
		! Deallocate memory (variable size)
		!------------------------------------------------------
		deallocate( trafo, ort, dif2mat, dif1mat, workr, H )
		deallocate( aval, diag )
		deallocate( work )
		call cpu_time( end_T4 )
		allocate_time = allocate_time + ( end_T4 - start_T4 )
	...
	print *, 'Allocate time =', ( allocate_time * 1000 ), '[ms]'
	print *, 'Program time =', ( program_time * 1000 ), '[ms]'
