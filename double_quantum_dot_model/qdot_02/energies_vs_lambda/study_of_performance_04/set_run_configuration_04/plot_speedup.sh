...
I = {0.0, 1.0}
VoxelDistance = 0.0
## Last datafile plotted: "speedup.dat"
set terminal pdf size 4,4;set output 'plot_speedup.pdf'

set multiplot layout 1,1
    set title "perf command, JupiterAce \n OpenBLAS + Posix threads + gfortran optimization flags"     
    set xlabel "# Posix threads";set ylabel "Speedup"
    set grid;set key font ",16";set xlabel  font ",16" ;set ylabel  font ",16"
    set yrange[1:100];set xrange[1:28]
    set label left
    set logscale y

    # fitting with Amdal's law
    f(x)=1/(q+p/x)
...
# =======================            ==========================
# q               = 0.222956         +/- 0.02384      (10.69%)
# p               = 0.738973         +/- 0.06962      (9.421%)
